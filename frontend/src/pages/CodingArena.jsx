...
export default function CodingArena() {
  ...
  // State for Learning Curriculum
  const [selectedTopic, setSelectedTopic] = useState(null);
  const [curriculumSubTab, setCurriculumSubTab] = useState("lectures");
  ...
  return (
    <main className="overflow-x-hidden w-full max-w-full min-h-screen bg-[#09090b] text-zinc-100 p-4 md:p-8 lg:p-10 font-sans selection:bg-purple-950 selection:text-purple-200">
      <div ref={containerRef} className="max-w-6xl mx-auto space-y-8">
        ...
        <header className="gsap-reveal flex flex-col lg:flex-row lg:items-center justify-between gap-6 border-b border-zinc-800/80 pb-6">
          <div className="space-y-1.5 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-950/50 border border-purple-800/50 text-purple-400 text-xs font-mono">
              <Terminal className="w-3.5 h-3.5" />
              <span>Coding & DSA Pillar • 2,800+ Official Problems & Sandbox</span>
            </div>
            <h1 className="text-2xl md:text-3xl font-bold text-zinc-100 tracking-tight">
              Coding & Algorithmic Workspace
            </h1>
            <p className="text-zinc-400 text-xs leading-relaxed max-w-2xl">
              Solve real interview coding challenges with live Python execution, sub-millisecond test evaluations, benchmark gap analysis, and structured learning tracks.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-zinc-100 hover:bg-white text-zinc-950 font-semibold text-xs transition-all shadow-md shadow-zinc-950/50 cursor-pointer uppercase tracking-wider font-mono"
            >
            ...
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-200 font-medium text-xs transition-all font-mono"
            >
        ...
        <nav className="gsap-reveal flex items-center gap-2 overflow-x-auto pb-1 font-mono text-xs">
          {[
            ...
            { id: "learning", label: "Curriculum Modules", icon: GraduationCap },
          ].map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              ...
              >
                <Icon className={`w-3.5 h-3.5 ${isActive ? "text-zinc-950" : "text-purple-400"}`} />
                <span>{tab.label}</span>
              </button>
            );
          })}
        ...
        {workspaceTab === "overview" && (
          <div className="space-y-6">
            {/* Quick Hero Banner */}
            <section className="gsap-reveal rounded-2xl bg-gradient-to-br from-[#121215] via-[#141418] to-purple-950/20 border border-zinc-800/90 p-6 md:p-8 space-y-6">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div className="space-y-3">
                  ...
                  <div className="flex items-baseline gap-3">
                    <span className="text-4xl md:text-5xl font-bold font-mono text-zinc-100 tracking-tight">
                      {solvedCount > 0 ? Math.min(100, Math.round((solvedCount / 150) * 100)) : 82}
                    </span>
                    ...
                    <div className="hidden sm:flex flex-col text-xs text-zinc-400 pl-4 border-l border-zinc-800 space-y-0.5 font-mono">
                      <div>
                        Target Bar: <span className="text-zinc-200">85 / 100</span>
                      </div>
                      <div>
                        Status: <span className="text-emerald-400">Competitive (+3 pts)</span>
                      </div>
                    </div>
                  </div>

                  <p className="text-xs text-zinc-400 max-w-xl leading-relaxed">
                    Evaluated across Arrays, Trees, Dynamic Programming, and Graph algorithms with sub-millisecond execution verification.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-1 gap-3 bg-zinc-900/90 border border-zinc-800 p-4 rounded-xl shrink-0 text-xs font-mono">
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-1 lg:gap-6">
                    ...
                    <span className="font-semibold text-purple-400">{solvedCount} / {stats.total}</span>
                  </div>
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-1 lg:gap-6 border-l lg:border-l-0 lg:border-t border-zinc-800 pl-3 lg:pl-0 lg:pt-2">
                    <span className="text-zinc-500 text-[11px]">Target Goal</span>
            ...
            <section className="gsap-reveal grid grid-cols-2 md:grid-cols-4 gap-3.5">
              <div className="p-4 rounded-xl bg-[#121215] border border-zinc-800/80 hover:border-zinc-700 flex items-center gap-4 transition-colors">
                ...
                <div>
                  ...
                  <div className="text-xl font-bold font-mono text-zinc-100 flex items-baseline gap-1">
              ...
              <div className="p-4 rounded-xl bg-[#121215] border border-zinc-800/80 hover:border-zinc-700 flex items-center gap-4 transition-colors">
                <div className="w-10 h-10 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 font-bold font-mono shrink-0">
                  E
                </div>
                <div>
              ...
              <div className="p-4 rounded-xl bg-[#121215] border border-zinc-800/80 hover:border-zinc-700 flex items-center gap-4 transition-colors">
                <div className="w-10 h-10 rounded-lg bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 font-bold font-mono shrink-0">
                  M
                </div>
                <div>
              ...
              <div className="p-4 rounded-xl bg-[#121215] border border-zinc-800/80 hover:border-zinc-700 flex items-center gap-4 transition-colors">
                <div className="w-10 h-10 rounded-lg bg-rose-500/10 border border-rose-500/20 flex items-center justify-center text-rose-400 font-bold font-mono shrink-0">
                  H
                </div>
                <div>
                  <div className="text-[11px] font-mono text-zinc-500">Hard Solved</div>
                  <div className="text-xl font-bold font-mono text-rose-400 flex items-baseline gap-1">
            ...
            <section className="gsap-reveal grid grid-cols-1 md:grid-cols-3 gap-4">
              <div
                ...
                className="bg-[#121215] border border-zinc-800/90 hover:border-purple-500/40 rounded-xl p-5 space-y-3 cursor-pointer transition-colors group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Terminal className="w-4 h-4 text-purple-400" />
                    <h4 className="text-xs font-semibold text-zinc-200 group-hover:text-purple-300">
                      Problem Catalog & Sandbox
                    </h4>
                  </div>
                ...
                <p className="text-[11px] text-zinc-400 leading-relaxed">
                  Browse 2,800+ LeetCode problems with difficulty filters, curated Blind 75 and Top 150 tracks, and live Python runtime.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-[11px] text-zinc-400 leading-relaxed">
                  Benchmark your proficiency across 12 DSA topics against specific target company hiring cutoffs.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-[11px] text-zinc-400 leading-relaxed">
                  Watch structured algorithmic lectures with synchronized problem assignments for Arrays, Graphs, and DP.
                </p>
              </div>
            </section>
          </div>
        ...
        {workspaceTab === "practice" && (
          <div className="space-y-6">
            ...
            <div className="gsap-reveal bg-[#121215] border border-zinc-800/90 rounded-xl p-4 space-y-3.5">
              <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    type="text"
                    placeholder="Search problem title, tags, or ID (e.g. Two Sum, 1, DP)..."
                    value={searchQuery}
                    onChange={(e) => {
              ...
              {/* Topic Tag Chips */}
              {tags.length > 0 && (
                <div className="flex items-center gap-2 flex-wrap pt-2 border-t border-zinc-800/60 font-mono">
            ...
            {/* Problems List Table */}
            <div className="gsap-reveal bg-[#121215] border border-zinc-800/90 rounded-xl overflow-hidden shadow-xl">
              <div className="p-4 border-b border-zinc-800/80 flex items-center justify-between font-mono">
              ...
              {loading ? (
                <div className="p-16 text-center space-y-3">
                  ...
                  <p className="text-xs text-zinc-400 font-mono">Fetching problem catalog...</p>
                </div>
              ) : error ? (
                ...
                <div className="p-16 text-center space-y-3">
                  <Code2 className="w-10 h-10 text-zinc-600 mx-auto" />
                  <h3 className="text-sm font-semibold text-zinc-300">No matching problems found</h3>
                          ...
                          >
                            ...
                            <td className="py-3.5 px-4">
                              <div className="space-y-0.5">
                                ...
                                {prob.preview && (
                                  <p className="text-[11px] text-zinc-500 line-clamp-1 max-w-xl">
                                    {prob.preview}
                                  </p>
                                )}
                              </div>
                            ...
                            <td className="py-3.5 px-4">
                              <span
                                className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold font-mono border ${getDifficultyColor(
                                  prob.difficulty
                                )}`}
                              >
                                {prob.difficulty}
                            ...
                            <td className="py-3.5 px-4 text-right">
                              <Link
                                ...
                                className={`inline-flex items-center gap-1 px-3 py-1 rounded-md text-xs font-medium transition-all ${
                                  isSolved
                                    ? "bg-zinc-800 hover:bg-zinc-700 text-emerald-400 border border-emerald-500/20 font-mono"
              ...
              {/* Pagination Footer */}
              <div className="p-4 border-t border-zinc-800/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-zinc-400">
                <div>
                ...
                {curriculumSubTab === "lectures" ? (
                  <div className="grid gap-6">
                    {selectedTopic.lectures?.map((lecture) => (
                      <VideoPlayer key={lecture.id} lecture={lecture} />
                    ))}
                  </div>
                ) : (
                  <AssignmentList assignments={selectedTopic.assignments} />
                )}
              </div>
            ) : (
