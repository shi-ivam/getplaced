      ...
      <div ref={containerRef} className="max-w-6xl mx-auto space-y-8">
        ...
        <header className="gsap-reveal flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-zinc-800/80 pb-6">
          <div className="max-w-3xl space-y-1.5">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900 border border-zinc-800 text-purple-400 text-xs font-mono">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed max-w-2xl">
              Solve real interview coding challenges with live Python execution, sub-millisecond test evaluations, and automated complexity profiling.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-zinc-100 hover:bg-white text-zinc-950 font-semibold text-xs transition-all shadow-md shadow-zinc-950/50 cursor-pointer uppercase tracking-wider"
            >
        ...
        {/* Gapless Bento Stat Cards */}
        <section className="gsap-reveal grid grid-cols-2 md:grid-cols-4 grid-flow-dense gap-3.5">
          <div className="p-4 rounded-xl bg-[#121215] border border-zinc-800/80 hover:border-zinc-700 flex items-center gap-4 transition-colors">
            ...
            <div>
              <div className="text-[11px] font-mono text-zinc-500">Solved / Catalog</div>
          ...
          <div className="p-4 rounded-xl bg-[#121215] border border-zinc-800/80 hover:border-zinc-700 flex items-center gap-4 transition-colors">
            ...
            <div>
              <div className="text-[11px] font-mono text-zinc-500">Easy Difficulty</div>
          ...
          <div className="p-4 rounded-xl bg-[#121215] border border-zinc-800/80 hover:border-zinc-700 flex items-center gap-4 transition-colors">
            ...
            <div>
              <div className="text-[11px] font-mono text-zinc-500">Medium Difficulty</div>
          ...
          <div className="p-4 rounded-xl bg-[#121215] border border-zinc-800/80 hover:border-zinc-700 flex items-center gap-4 transition-colors">
            ...
            <div>
              <div className="text-[11px] font-mono text-zinc-500">Hard Difficulty</div>
