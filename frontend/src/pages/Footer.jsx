        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-16 border-b border-[#428475]/30">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs font-medium">
              <li><a href="#hero" className="hover:text-[#89D7B7] transition-colors">AI Interview Simulator</a></li>
              <li><a href="#features" className="hover:text-[#89D7B7] transition-colors">Bento Capabilities</a></li>
              <li><a href="#resume" className="hover:text-[#89D7B7] transition-colors">ATS Resume Radar</a></li>
              <li><a href="#calendar" className="hover:text-[#89D7B7] transition-colors">Roadmap Calendar</a></li>
            </ul>
          </div>

          {/* Links 2 */}
          <div>
            <h4 className="text-xs font-mono uppercase tracking-widest text-[#89D7B7] font-bold mb-4">Security & Tech</h4>
            <ul className="space-y-2 text-xs font-medium">
