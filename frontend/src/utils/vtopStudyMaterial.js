/**
 * Study Material Mapping Utility for VTOP Courses
 * Directs students to course-specific resources on vhelpcc.com
 */
...
export function getSubjectStudyMaterialUrl(code = "", title = "") {
